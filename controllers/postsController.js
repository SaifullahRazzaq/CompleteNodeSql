...
exports.list_category_post = function(req, res) {
  Post.getPostByCategory(req.params.category_id, function(err, posts) {
    if (err)
      res.send(err);
    console.log('res', posts);
    res.send(posts);
...
exports.list_category_post_date = function(req, res) {
  Post.getPostByDate(req.params.from_date,req.params.to_date, function(err, posts) {
    if (err)
      res.send(err);
    console.log('res', posts);
    res.send(posts);
